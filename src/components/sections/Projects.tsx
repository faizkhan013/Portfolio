...
function ProjectCard({ project, index }: { project: any; index: number }) {
  return (
    <motion.div
      ...
      style={{
        padding: '1.5rem', background: 'var(--surface)', border: `1px solid ${project.featured ? 'rgba(124,58,237,0.35)' : 'var(--border)'}`,
        borderRadius: 'var(--radius)', display: 'flex', flexDirection: 'column', position: 'relative', overflow: 'hidden',
        transition: 'all 0.3s', background: project.featured ? 'rgba(124,58,237,0.05)' : 'var(--surface)'
      }}
